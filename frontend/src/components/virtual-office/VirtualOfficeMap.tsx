...
const ROOMS: RoomConfig[] = [
  ...
  { zone: "developer_zone",     label: "Developer",      stepNames: ["technical_design", "dev_tasks", "code_review"], navPath: "documents" },
  { zone: "qa_lab",             label: "QA Lab",         stepNames: ["test_cases"],                          navPath: "documents" },
  { zone: "devops_room",        label: "DevOps",         stepNames: ["devops_tasks"],                        navPath: "documents" },
  { zone: "monitoring_room",    label: "Monitoring",     stepNames: ["monitoring"],                          navPath: "documents" },
